    ...
    (() => {
        ...
        if (document.querySelector("[data-datepicker]")) {
            const picker = datepicker_min("[data-datepicker]", {
                customDays: [ "Mon", "Tue", "Wed", "Th", "Fr", "Sat", "Sun" ],
        ...
        function initSliders() {
            //!! SLIDER GALLERY
            if (document.querySelector(".galery-destiantion__slider")) new core(".galery-destiantion__slider", {
                ...
                navigation: {
                    prevEl: ".galery-destiantion__button-prev",
                    nextEl: ".galery-destiantion__button-next"
                },
                on: {}
            });
            //!   Revies SLIDER
                        if (document.querySelector(".reviews__slider")) var swiper = new core(".reviews__slider", {
            ...
            observer.observe(document.querySelector(".reviews__slider"));
        }
        ...
        function social() {
            const blockSocial = document.querySelector(".block-social");
            ...
            targetBlocks.forEach((function(targetBlock) {
                ...
                if (targetBlockPosition < windowHeight) setTimeout((function() {
                    blockSocial.classList.add("color-blue");
                    blockSocial.classList.remove("color-white");
                }), 500); else setTimeout((function() {
                    blockSocial.classList.remove("color-blue");
                    blockSocial.classList.add("color-white");
                }), 300);
            }));
        }
        function services() {
            const element = document.querySelector(".services__body");
            const position = element.getBoundingClientRect().top;
            const screenHeight = window.innerHeight;
            if (position < screenHeight) element.classList.add("animate");
        }
        function trips() {
            const element = document.querySelector(".trips__block");
            const position = element.getBoundingClientRect().top;
            const screenHeight = window.innerHeight;
            if (position < screenHeight) element.classList.add("animate-trip");
        }
        function hideBlockOnScroll() {
            const blockSocial = document.querySelector(".block-social");
            const footer = document.querySelector("footer");
            if (!blockSocial || !footer) return;
            const observer = new IntersectionObserver((function(entries) {
                entries.forEach((function(entry) {
                    if (entry.isIntersecting) blockSocial.style.opacity = "0"; else blockSocial.style.opacity = "1";
                }));
            }));
