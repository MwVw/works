(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".rooms__slider")) new swiper_core_Swiper(".rooms__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
        ...
        if (document.querySelector(".tips__slider")) new swiper_core_Swiper(".tips__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
...
***************************************************************************** */
    ...
    if (furniture && !isMobile.any()) {
        ...
        furniture.addEventListener("mousemove", (function(e) {
            ...
            if (!furniture.classList.contains("_unit")) {
                requestAnimationFrame(setMouseGalleryStyle);
                furniture.classList.add("_unit");
            }
        }));
    }
    window["FLS"] = true;
