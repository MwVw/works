(() => {
    ...
    function initSliders() {
        if (document.querySelector(".benefits__slider")) var swiper = new core(".benefits__slider", {
        ...
        observer.observe(document.querySelector(".benefits__slider"));
        if (document.querySelector(".development__slider")) new core(".development__slider", {
        ...
        if (document.querySelector(".maintain__slider")) new core(".maintain__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
