(() => {
    ...
    function initSliders() {
        if (document.querySelector(".inner-pages__slider")) new swiper_core_Swiper(".inner-pages__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.5,
            ...
            speed: 800,
            navigation: {
                prevEl: ".inner-pages-button-prev",
                nextEl: ".inner-pages-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".client-words__slider")) new swiper_core_Swiper(".client-words__slider", {
            ...
            initialSlide: 1,
            pagination: {
                el: ".client-words-swiper-pagination",
                clickable: true
            },
            breakpoints: {
                320: {
